...
const About = () => {
  return (
    <div className="relative max-w-5xl 2xl:max-w-7xl mx-auto px-8 py-20" id="about">
      <div className="absolute -right-[600px] top-[10rem] -z-10 w-[780px] overflow-hidden blur-3xl sm:blur-none"
        aria-hidden="true">
